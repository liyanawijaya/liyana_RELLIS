...
default_hooks = dict(
    checkpoint=dict(by_epoch=False, interval=100000, type='CheckpointHook'),
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(img_path='image_NW', seg_map_path='annotatio_NW'),
        data_root='../GANav-offroad/data/rellis/',
        pipeline=[
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(img_path='image_NW', seg_map_path='annotation_NW'),
        data_root='../GANav-offroad/data/rellis/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations'),
