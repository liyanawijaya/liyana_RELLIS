...
train_dataloader = dict(
    batch_size=8,
    dataset=dict(
        ann_file='outback_DICTA_NW/train_rgb_new.txt',
        data_prefix=dict(
            img_path='outback_DICTA_NW/rgbd_outback_stacked_new',
            seg_map_path='outback_DICTA_NW/outback_masks_4_new_full'),
        data_root='../GANav-offroad/data/',
        pipeline=[
            dict(type='LoadNpyAsImage'),
            dict(type='LoadAnnotations'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            img_path='outback_DICTA_NW/test_data_3/rgbd_stacked_test',
            seg_map_path=
            'outback_DICTA_NW/test_data_3_mask/outback_masks_4_new_test'),
        data_root='../GANav-offroad/data/',
        pipeline=[
            dict(type='LoadNpyAsImage'),
            dict(keep_ratio=False, scale=(
