...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file='test.txt',
        data_prefix=dict(img_path='rgb_stacked', seg_map_path='outback_mask'),
        data_root='../GANav-offroad/data/outback_DICTA_NW/',
        pipeline=[
...
test_evaluator = dict(prefix='val_loss', type='CustomLossMetric')
test_pipeline = [
    dict(type='LoadNpyAsImage'),
    dict(keep_ratio=False, scale=(
        2048,
...
val_dataloader = dict(
    ...
    persistent_workers=True,
    sampler=dict(shuffle=False, type='DefaultSampler'))
val_evaluator = dict(prefix='val_loss', type='CustomLossMetric')
vis_backends = [
