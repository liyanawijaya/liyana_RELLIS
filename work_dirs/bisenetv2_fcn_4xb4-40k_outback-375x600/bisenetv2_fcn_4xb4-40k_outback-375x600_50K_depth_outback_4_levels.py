...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            ...
            seg_map_path='outback_DICTA_NW/depth_outback_masks_4_levels'),
        data_root='../GANav-offroad/data/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            #dict(type='LoadAnnotations'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            img_path='outback_DICTA_NW/test_data_3/depth_outback_4_env',
            seg_map_path=
            'outback_DICTA_NW/test_data_3_mask/rgb_masks_outback_4_levels'),
        data_root='../GANav-offroad/data/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(keep_ratio=False, scale=(
