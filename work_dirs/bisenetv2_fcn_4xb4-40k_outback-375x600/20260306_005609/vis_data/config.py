...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            ...
            seg_map_path='outback_thesis/complex_masks_blur_4_levels'),
        data_root='../GANav-offroad/data/',
        pipeline=[
            dict(type='LoadNpyAsImage'),
            dict(type='LoadAnnotations'),
        ...
        seg_map_path_aux='outback_thesis/complex_masks_4_levels',
        type='OUTBACKDataset'),
    num_workers=4,
    persistent_workers=True,
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            ...
            seg_map_path='outback_thesis/masks_test_4_levels'),
        data_root='../GANav-offroad/data/',
        pipeline=[
            dict(type='LoadNpyAsImage'),
            dict(type='LoadAnnotations'),
        ...
        seg_map_path_aux='outback_thesis/masks_test_4_levels',
        type='OUTBACKDataset'),
    num_workers=4,
    persistent_workers=True,
    sampler=dict(shuffle=False, type='DefaultSampler'))
