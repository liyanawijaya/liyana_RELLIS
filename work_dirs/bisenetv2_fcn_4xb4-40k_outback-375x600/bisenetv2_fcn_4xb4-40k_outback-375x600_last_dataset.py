...
train_cfg = dict(max_iters=50000, type='IterBasedTrainLoop', val_interval=5000)
train_dataloader = dict(
    batch_size=8,
    dataset=dict(
        ann_file='outback_DICTA_NW/mixed_train.txt',
        data_prefix=dict(
            img_path='outback_DICTA_NW/outback_depth_sky_white_new',
            seg_map_path='outback_DICTA_NW/masks_3_levels_for_rellis'),
        data_root='../GANav-offroad/data/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            #dict(type='LoadAnnotations'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            img_path='rellis/RELLIS_DEPTH_TEST_new',
            seg_map_path='rellis/rellis_3_level_masks_test'),
        data_root='../GANav-offroad/data/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(keep_ratio=False, scale=(
