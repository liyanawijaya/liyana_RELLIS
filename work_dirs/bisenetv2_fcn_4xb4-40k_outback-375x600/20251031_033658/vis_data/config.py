...
train_dataloader = dict(
    batch_size=8,
    dataset=dict(
        ann_file='outback_DICTA_NW/mixed_train_1.txt',
        data_prefix=dict(
            img_path='outback_DICTA_NW/rgbd_new',
            seg_map_path='outback_DICTA_NW/rgb_mask_3_levels_grass'),
        data_root='../GANav-offroad/data/',
        pipeline=[
            dict(type='LoadNpyAsImage'),
            dict(type='LoadAnnotations'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            ...
            seg_map_path='outback_DICTA_NW/test_data_3/test_mask_3_levels_grass'
        ),
        data_root='../GANav-offroad/data/',
        pipeline=[
            dict(type='LoadNpyAsImage'),
