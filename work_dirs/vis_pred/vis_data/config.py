...
launcher = 'none'
load_from = 'work_dirs/bisenetv2_fcn_4xb4-40k_outback-375x600/iter_100000.pth'
log_level = 'INFO'
...
param_scheduler = [
    dict(
        begin=0, by_epoch=False, end=300000, start_factor=0.1,
        type='LinearLR'),
    dict(
        begin=300000,
        by_epoch=False,
...
test_evaluator = [
    dict(name='mAP', num_classes=16, type='CustomSegmentationMAP'),
]
test_pipeline = [
    dict(type='LoadNpyAsImage'),
    dict(keep_ratio=False, scale=(
...
train_cfg = dict(max_iters=400000, type='IterBasedTrainLoop', val_interval=50)
