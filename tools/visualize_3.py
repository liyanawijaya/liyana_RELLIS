...
checkpoint_file = 'work_dirs/bisenetv2_fcn_4xb4-40k_outback-375x600/iter_100000.pth'

# === Image path and output paths ===
img_path = 'rgb_3511.png' #my comment
#npy_path='rgb_0346.npy' #my code
out_file = 'work_dirs/vis_preds/result_image_NW_68.png'
