...
class BaseSegDataset(BaseDataset):
    ...
    Supports optional auxiliary GT folders:
        data_prefix['seg_map_path_aux']
        data_prefix['seg_map_path_aux2']
    """
    ...
    def load_data_list(self) -> List[dict]:
        ...
        Supports:
            main GT  -> seg_map_path
            aux GT 1 -> seg_map_path_aux
            aux GT 2 -> seg_map_path_aux2
        """
        ...
        ann_dir_aux2 = self.data_prefix.get('seg_map_path_aux2', None)
        ...
        if osp.isfile(self.ann_file):
            ...
            for line in lines:
                ...
                if ann_dir_aux:
                    ...
                    data_info['seg_map_path_aux'] = osp.join(
                        ann_dir_aux, seg_map_aux
                    )

                if ann_dir_aux2:
                    seg_map_aux2 = img_name + self.seg_map_suffix
                    data_info['seg_map_path_aux2'] = osp.join(
                        ann_dir_aux2, seg_map_aux2
                    )
